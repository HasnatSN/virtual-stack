...
from virtualstack.services.iam import role_service, permission_service
...
async def list_roles(
    ...
    """
    roles = await role_service.get_by_tenant(
...
async def update_role(
    ...
    # Update the role
    updated_role = await role_service.update(db, db_obj=role, obj_in=role_in)
    return updated_role
