...
DEFAULT_PERMISSIONS = [
    # IAM permissions
    {"key": "tenant.user.invite", "name": "Invite Users", "description": "Can invite users to the tenant"},
    {"key": "tenant.user.manage", "name": "Manage Users", "description": "Can manage users in the tenant"},
    {"key": "tenant.role.manage", "name": "Manage Roles", "description": "Can manage roles in the tenant"},
    ...
    {"key": "vm.template.upload", "name": "Upload Templates", "description": "Can upload VM templates"},
    {"key": "vm.template.manage", "name": "Manage Templates", "description": "Can manage VM templates"},
    
    # Support permissions
    {"key": "support.ticket.create", "name": "Create Tickets", "description": "Can create support tickets"},
    {"key": "support.ticket.view", "name": "View Tickets", "description": "Can view support tickets"},
